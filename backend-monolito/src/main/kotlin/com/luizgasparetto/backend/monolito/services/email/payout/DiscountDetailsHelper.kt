...
/**
 * Helper global para calcular e gerar HTML de detalhamento de descontos (taxas e margens) usado em
 * emails de repasse e pagamento ao autor.
 */
object DiscountDetailsHelper {
    ...
    /**
     * Calcula o detalhamento completo do desconto (fee, margin, total) usando as mesmas regras do
    ...
    private fun calculateDiscountDetailsInternal(
            ...
            calculateDiscountDetailsInternal(
                    amountGross,
    ...
    fun buildDiscountDetailsBlock(
            ...
            buildDiscountDetailsBlockInternal(
                    details,
                    payoutProps.marginPercent,
                    payoutProps.marginFixed,
                    efiRealFeePercent,
    ...
    private fun buildDiscountDetailsBlockInternal(
        ...
        val efiFeeLine =
                if (efiRealFeePercent != null && paymentTypeLabel != null) {
                    val hundred = BigDecimal("100")
