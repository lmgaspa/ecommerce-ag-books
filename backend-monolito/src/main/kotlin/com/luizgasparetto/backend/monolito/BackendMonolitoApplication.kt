...
@EnableScheduling
@EnableConfigurationProperties(PrivacyProps::class, PixEfiProperties::class, CardEfiProperties::class, EfiPayoutProps::class, BootstrapAuthorProperties::class, CouponProperties::class)
