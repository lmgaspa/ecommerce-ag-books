...
/**
 * Controller de compatibilidade para webhooks PIX da EFI.
 * Aceita URLs antigas/incorretas como /api/webhooks/payment/pix/pix
 * e redireciona para o mesmo handler do PixEfiWebhookController.
 */
@RestController
...
class PixEfiWebhookCompatController(
    ...
    fun handle(@RequestBody rawBody: String): ResponseEntity<String> {
        log.warn("EFI WEBHOOK COMPAT: recebido em endpoint de compatibilidade - URL antiga/incorreta")
