...
class EfiPixPayoutProvider(
    ...
    override fun sendPixPayout(orderId: Long, amount: BigDecimal, favoredPixKey: String): String {
        ...
        // ✅ usa ConnectionConfig (não-deprecado) para connect timeout
        ...
        // RequestConfig ainda é válido para response/conn-request timeout
